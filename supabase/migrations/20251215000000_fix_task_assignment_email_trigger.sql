-- Fix: Email HTML and text generation was outside the IF block
-- This caused NULL values in body_html and body_text
...
BEGIN
    ...
    IF v_should_send THEN
        ...
        -- Safety check: Ensure we got valid email
        ...
        -- Format due date
        v_due_date_formatted := COALESCE(NEW.due_date, 'Not set');
        
        -- Create email subject
        v_email_subject := 'New Task Assignment: ' || NEW.task_name || ' - ' || COALESCE(v_project_name, 'Unknown Project');
