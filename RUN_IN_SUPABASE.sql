-- Run these queries in Supabase SQL Editor BEFORE deploying
-- URL: https://supabase.com/dashboard/project/tiiuowhbntuoepxpnobs/sql

-- ============================================
-- 1. ADD PROJECT MANAGER COLUMN (if not already done)
-- ============================================
ALTER TABLE public.projects 
ADD COLUMN IF NOT EXISTS project_manager_name TEXT;

-- ============================================
-- 2. ADD PROJECT MANAGER EMAIL NOTIFICATION TRIGGER
-- ============================================
...
This is an automated notification from zHeight Project Management System';
            ...
            -- Insert email notification (GOES TO QUEUE - NO DIRECT SEND)
...
-- ============================================
-- 3. VERIFY SETUP (Check if everything is working)
-- ============================================
...
AND column_name = 'project_manager_name';

-- Check if trigger exists
SELECT trigger_name, event_manipulation, event_object_table 
FROM information_schema.triggers 
WHERE trigger_name = 'trigger_log_pm_assignment_email';

-- Check if function exists
SELECT routine_name 
FROM information_schema.routines 
WHERE routine_name = 'log_pm_assignment_email';

-- Done! Now you can test by creating a new project with PM assigned
